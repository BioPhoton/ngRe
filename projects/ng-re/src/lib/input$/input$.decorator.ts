...
import {getPropertySubject, getReplaySubjectFactory} from '../core/get-property-subject';
  ...
  return (
    ...
    const propertyKeyDescriptor: TypedPropertyDescriptor<Observable<T>> = {
      set(newValue) {
        ...
        getPropertySubject<any>(this, keyUniquePerPrototype, getReplaySubjectFactory(1)).next(newValue);
      },
      get() {
        return getPropertySubject<any>(this, keyUniquePerPrototype, getReplaySubjectFactory(1));
      }
    };
